        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                <div class="box mt-4" v-if="invoice.client">
                    ...
                    <p v-if="invoice.client.address_1">{{ invoice.client.address_1 }}</p>
                    <p v-if="invoice.client.address_2">{{ invoice.client.address_2 }}</p>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.invoice.client_address_1 = this.invoice.client.address_1
            this.invoice.client_address_2 = this.invoice.client.address_2
