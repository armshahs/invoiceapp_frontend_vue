        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-6">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="address_1" class="input" v-model="client.address_1">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="address_2" class="input" v-model="client.address_2">
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        submitForm() {
            axios
                .post("/api/v1/create_client/", this.client)
                .then(response => {
                    toast({
                        message: 'The client were added',
                        type: 'is-success',
                        dismissible: true,
                        pauseOnHover: true,
                        duration: 2000,
